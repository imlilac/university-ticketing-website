            ...
            <div class="ticket-send">
               ...
               <div class="ticket-send__answer">
                  ...
                  <div class="ticket-send__answer-bottom">
                     <span class="ticket-send__answer-name ticket-send__answer-span">فاطمه کرابی</span>
                     <span class="ticket-send__answer-date ticket-send__answer-span">2022-11-29</span>
                     <span class="ticket-send__answer-time ticket-send__answer-span">14:28</span>
                  </div>
               </div>
               <div class="ticket-send__title">
                  <span class="ticket-send__title-text">
               ...
               {ticketInfo.answer === null ? (
                  <div className="alert alert-danger">هنوز پاسخی برای تیکت ارسال نشده</div>
               ) : (
                  <div class="ticket-send__answer-user">
                     ...
                     <div class="ticket-send__answer-user-bottom">
                        <span class="ticket-send__answer-user-name ticket-send__answer-user-span">ادمین</span>
                        <span class="ticket-send__answer-user-date ticket-send__answer-user-span">2022-11-29</span>
                        <span class="ticket-send__answer-user-time ticket-send__answer-user-span">14:28</span>
                     </div>
                  </div>
               )}
            </div>
